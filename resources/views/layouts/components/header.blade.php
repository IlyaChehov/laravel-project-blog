    ...
    <div class="container-fluid">
        <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
            ...
            <a class="navbar-brand" href="# marketing-index.html"><img
                        src="{{ asset('assets/images/version/market-logo.png') }}" alt=""></a>
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="# marketing-index.html">Register</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="# marketing-index.html">Login</a>
                    </li>
                </ul>
